...
metadata = {
    "protocolName":"Test Dyes Unmixed",
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    green_tip = tiprack["D11"]
    blue_tip = tiprack["C11"]
    ...
    for num in range(1,11):
        ...
        right_pipette.dispense(150, plate[f"B{num}"].top())
    ...
    for num in range(1,11):
        ...
        right_pipette.dispense(1 * num,plate[f"B{num}"].bottom())
    ...
    for num in range(10, 0, -1):
        ...
        right_pipette.dispense(1 * num, plate[f"B{11-num}"].bottom())
